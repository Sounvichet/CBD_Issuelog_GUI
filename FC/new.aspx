<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new.aspx.cs" Inherits="FC_new" %>
            ...
            <div class="card">
              <div class="card-header d-flex p-0">
                ...
                <ul class="nav nav-pills ml-auto p-2">
                  <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">FC_USD</a></li>
                  <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="tab">FC_KHR</a></li>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                      <div class="row">
                          <div class="col-md-3">ID_CARD <strong style="color:red">*</strong></div>
                      <div class="col-md-3">
                      <asp:TextBox ID="T_ID_CARD" runat="server" CssClass="textboxstyle"></asp:TextBox>    
                      </div>
                          <div class="col-md-3">FC_NAME</div>
                      <div class="col-md-3">
                      <asp:TextBox ID="T_FC_NAME_USD" runat="server" CssClass="textboxstyle"></asp:TextBox>    
                      </div>
                      </div>

                      <div class="row user-control">
                          <div class="col-md-3">FC_SEX</div>
                      <div class="col-md-3">
                      <asp:TextBox ID="T_FC_SEX_USD" runat="server" CssClass="textboxstyle"></asp:TextBox>    
                      </div>
                          <div class="col-md-3">FC_POSITION</div>
                      <div class="col-md-3">
                          <asp:TextBox ID="T_FC_POSITION_USD" runat="server" CssClass="textboxstyle"></asp:TextBox>
                      </div>
                      </div>

                      <div class="row user-control">
                          <div class="col-md-3">FC_INST
                         
                          </div>
                      <div class="col-md-3">
                      <asp:TextBox ID="T_FC_INST_USD" runat="server" CssClass="textboxstyle"></asp:TextBox>    
                      </div>

                           <div class="col-md-3">FC_Phone
                         
                          </div>
                      <div class="col-md-3">
                      <asp:TextBox ID="T_FC_phone" runat="server" CssClass="textboxstyle"></asp:TextBox>    
                      </div>
                  ...
                  <div class="tab-pane" id="tab_2">
                   <div class="row">
                          <div class="col-md-3">FC_NAME</div>
                      <div class="col-md-3">
                      <asp:TextBox ID="T_FC_NAME_KHR" runat="server" CssClass="textboxstyle"></asp:TextBox>    
                      </div>
                          <div class="col-md-3">FC_SEX</div>
                      <div class="col-md-3">
                      <asp:TextBox ID="T_FC_SEX_KHR" runat="server" CssClass="textboxstyle"></asp:TextBox>    
                      </div>
                      </div>
                      ...
                      <div class="row user-control">
                          <div class="col-md-3">FC_POSITION</div>
                      <div class="col-md-3">
                      <asp:TextBox ID="T_FC_POSITION_KHR" runat="server" CssClass="textboxstyle"></asp:TextBox>    
                      </div>
                          <div class="col-md-3">FC_INST</div>
                      <div class="col-md-3">
                      <asp:TextBox ID="T_FC_INST_KHR" runat="server" CssClass="textboxstyle"></asp:TextBox>    
                      </div>
                      </div>
