<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TBSWDIS.aspx.cs" Inherits="Payment_TBSWDIS" %>
<!DOCTYPE html>
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <i class="fa fa-money"></i>
                                                <h3 class="box-title" style="color:blue">Insert Wing Disputed</h3>
                                            </div>
                                            <div class="box-body">
                                                                ...
                                                                <a href="javascript:;" id="testClick"></a>
                                                                    ...
                                                                    <div class="row user-control">
                                                                          ...
                                                                          <div class="row">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12 textboxstyle category_bg">
                                                                                    <asp:Label id="Label2" runat="server" Font-Bold="true"  Text ="Wing Disputed listing"></asp:Label>
                                                                                </div>
                                                                            </div>
