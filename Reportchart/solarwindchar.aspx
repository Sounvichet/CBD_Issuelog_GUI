<%@ Page Language="C#" AutoEventWireup="true" CodeFile="solarwindchar.aspx.cs" Inherits="Reportchart_solarwindchar" %>
                                    ...
                                    <div class="box box-primary">
                                            <div class="box-body box-profile">
                                                 ...
                                                 <div class="col-md-8">
                                                     ...
                                                     <h3 class="box-title">Dialy ATM Service Dashboard <asp:Label ID="lbldailyuppercent" runat="server" Text="" Font-Bold="true"></asp:Label> % <asp:Label ID="lblcurrentdate" runat="server" Font-Bold="true" Text="Label"></asp:Label> </h3>  
                                                 </div>
			                                ...
			                                <ContentTemplate> 
                                                 <div class="row user-control">
                                                     ...
                                                     <div class ="col-md-6">
                                                         <div class="box box-info table-responsive">
                                                            <div class="box-header with-border">
                                                              <h3 class="box-title">Daily ATM Down Minutes History by Hour</h3>
                                                              <div class="box-tools pull-right">
                                                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                                                                </button>
                                                                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                                                            ...
                                                            <div class="box-body">
                                                                <asp:Chart ID="Chart5" runat=server Width="500px">
                                                                    <Series>
                                                                     ...
                                                                     <borderskin backcolor="Olive" bordercolor="Olive" skinstyle="Emboss" />
                                                                    <Legends>
                                                                        <asp:Legend Title="ByDate"></asp:Legend>    
                                                                    </Legends>
                                                                   ...
                                                                   <%-- <Titles>
                                                                    ...
                                                                    <ChartAreas>
                                                                        <asp:ChartArea Name="ChartArea1" BorderWidth="0" BackColor="WhiteSmoke">
                                                 ...
                                                 <div class ="row user-control">
                                                     <div class="col-md-12">
                                                          <div class="box box-primary table-responsive">
                                                            <div class="box-header with-border">
                                                              <h3 class="box-title">Current ATM Down</h3>
                                                              <div class="box-tools pull-right">
                                                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                                                                </button>
                                                                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                                                 ...
                                                 <div class="row">
                                                     <div class="col-md-12">
                                                         <div class="box box-primary table-responsive">
                                                            <div class="box-header with-border">
                                                                <div>
                                                                    <h3 class="box-title" style="color:blue">ATM Down Listing</h3>
                                                                </div>
                                                              <div>
                                                                  <table style="border:hidden" class="table table-bordered  table-responsive">
                                                                      <tr>
                                                                          <td>
                                                                              ...
                                                                              <asp:DropDownList ID="D_BranchName" runat="server" CssClass="textboxstyle form-control" AutoPostBack="true" OnSelectedIndexChanged="D_BranchName_SelectedIndexChanged" ></asp:DropDownList> <%----AppendDataBoundItems="true"--%>
                                                                          </td>
                                                                          <td>
                                                ...
                                                <Triggers>
                                                        <asp:PostBackTrigger ControlID="D_BranchName"/>
                                                 </Triggers>
                                    </asp:UpdatePanel>
                                                 <%--<div class="row">
                                                     <div class="col-md-6">
