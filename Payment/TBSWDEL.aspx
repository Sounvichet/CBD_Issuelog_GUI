<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TBSWDEL.aspx.cs" Inherits="Payment_TBSWDEL" %>
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12" align="left">
                                        <asp:LinkButton ID="Linkbtndelete" runat="server" CssClass="btn btn-sm btn-primary button_bg" OnClick="Btndelete_Click" OnClientClick="check();"><i class="fa fa-save fa-lg" aria-hidden="true" ></i> Delete</asp:LinkButton>
