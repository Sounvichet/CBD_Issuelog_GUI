<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new.aspx.cs" Inherits="EMPLOYEE_new" %>
...
<head runat="server">
  ...
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
    ...
    <script type="text/javascript">
           ...
           <script type="text/javascript">
            jQuery(function ($) {{
                    $("#<%=txtempdate.ClientID %>").datepicker({
                    format: 'dd-M-yyyy',
        ...
        <div class="card card-default color-palette-box">
          <div class="card-header">
            ...
            <div class="card-body">
                ...
                <div class="row user-control">
                    <div class="col-md-3">
                        BRANCHID<strong style="color:red">*</strong>
                    </div>
                    <div class="col-md-3">
                        <asp:DropDownList ID="D_branchID" runat="server" CssClass="textboxstyle" Width="75%"></asp:DropDownList>
                    </div>
                    <div class="col-md-3">
                        Employee Date
                    </div>
                    <div class="col-md-3">
                        <asp:TextBox ID="txtempdate" runat="server" CssClass="textboxstyle"></asp:TextBox>
                    </div>
                </div>
                 ...
                 <div class="row user-control">
                     ...
                     <div class ="col-md-3">
                         <asp:TextBox ID="txtFirstName" runat="server" CssClass="textboxstyle"></asp:TextBox>
                        </div>
                     <div class ="col-md-3">
                         Last Name
                        </div>
                     <div class ="col-md-3">
                         <asp:TextBox ID="txtLastName" runat="server" CssClass="textboxstyle"></asp:TextBox>
                        </div>
                 </div>
                     ...
                     <div class ="col-md-3">
                         <asp:TextBox ID="txtnameKhmer" runat="server" CssClass="textboxstyle"></asp:TextBox>
                        </div>
                     <div class ="col-md-3">
                         Gender
                        </div>
                ...
                <div class="row user-control">
                     ...
                     <div class ="col-md-3">
                         <asp:DropDownList ID="d_empStatus" runat="server" CssClass="textboxstyle"></asp:DropDownList>
                        </div>
                     <div class ="col-md-3">
                         Job title
                        </div>
                     <div class ="col-md-3">
                         <asp:DropDownList ID="d_jobttile" runat="server" CssClass="textboxstyle" Width="75%"></asp:DropDownList>
                        </div>
                 </div>
