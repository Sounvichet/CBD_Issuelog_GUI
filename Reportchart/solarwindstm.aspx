<%@ Page Language="C#" AutoEventWireup="true" CodeFile="solarwindstm.aspx.cs" Inherits="Reportchart_solarwindstm" %>
                                    ...
                                    <div class="box box-primary">
                                            <div class="box-body box-profile">
                                                 ...
                                                 <div class="col-md-8">
                                                     ...
                                                     <h3 class="box-title">Dialy STM Service Dashboard <asp:Label ID="lbldailyuppercent" runat="server" Text="" Font-Bold="true"></asp:Label> % <asp:Label ID="lblcurrentdate" runat="server" Font-Bold="true" Text="Label"></asp:Label> </h3>  
                                                 </div>
			                                ...
			                                <ContentTemplate> 
                                                 <div class="row user-control">
                                                     <div class="col-md-6">
                                                         <div class="box box-primary table-responsive">
                                                            <div class="box-header with-border">
                                                              <h3 class="box-title">STM Service live by status</h3>
                                                            ...
                                                            <div class="box-body">
                                                              ...
                                                              <%--<div class="chart" id="chart1" style="height: 300px;"></div>--%>
                                                                <asp:Chart ID="Chart2" runat=server Width="500px">
                                                                    ...
                                                                    <Legends>
                                                                        <asp:Legend Title="STM"></asp:Legend>
                                                                    </Legends>
                                                                   <%-- <Titles>
                                                     ...
                                                     <div class ="col-md-6">
                                                         <div class="box box-info table-responsive">
                                                            <div class="box-header with-border">
                                                              <h3 class="box-title">Daily STM Down Minutes History by Hour</h3>
                                                              <div class="box-tools pull-right">
                                                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                                                                </button>
                                                                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                                                 ...
                                                 <div class ="row user-control">
                                                     <div class="col-md-12">
                                                          <div class="box box-primary table-responsive">
                                                            <div class="box-header with-border">
                                                              <h3 class="box-title">Current STM Down</h3>
                                                              <div class="box-tools pull-right">
                                                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                                                                </button>
                                                                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                                                 ...
                                                 <div class="row">
                                                     <div class="col-md-12">
                                                         <div class="box box-primary table-responsive">
                                                            <div class="box-header with-border">
                                                                <div>
                                                                    <h3 class="box-title" style="color:blue">STM Down Listing</h3>
                                                                </div>
                                                              <div>
