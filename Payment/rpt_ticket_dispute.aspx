<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_ticket_dispute.aspx.cs" Inherits="payment_rpt_ticket_dispute" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title" style="color: blue">CSS Dispute Report Dashboard</h3>
                            </div>
                            <div class="box-body">
