<%@ Page Language="C#" AutoEventWireup="true" CodeFile="customerupload.aspx.cs" Inherits="CUSTOMERS_customerupload" %>
                            ...
                            <div class="col-md-12">
                                <table style="width:100%" >
                                       <tr>
                                           ...
                                           <td>    
                                              <asp:DropDownList ID="d_serviceID" runat="server" CssClass ="textboxstyle" Width="100%" AutoPostBack ="true"  OnSelectedIndexChanged="d_serviceID_SelectedIndexChanged"></asp:DropDownList>
                                           </td>
                                           <td class="tdname">
                                                   លើកទី
                                ...
                                <table style="width:100%">
                                         <tr>
                                             <td class="tdname"​​>
                                                 ...
                                                 រូបភាព<span style="color:red">*</span>
