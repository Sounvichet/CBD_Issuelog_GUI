<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VISAWFL.aspx.cs" Inherits="Payment_VISAWFL" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function RadioCheck(rb) {
            var gv = document.getElementById("<%=GetGrid_Visa_list.ClientID%>");
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title" style="color: blue">VISA Payment</h3>
                            </div>
                            <div class="box-body">
                                    ...
                                    <div class="col-md-12">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-sm button_bg button3"><span style="color:white">Action</span></button>
                                                        <button type="button" class="btn btn-sm dropdown-toggle button_bg button3" data-toggle="dropdown">
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label3" runat="server" Font-Bold="true" Text="VISA Settlement by NNSS SERVICE USD"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="grid_visa_sttl" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label4" runat="server" Font-Bold="true" Text="VISA Settlement by NNSS SERVICE KHR"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="grid_visa_146" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                                <HeaderStyle CssClass="gvHeaderCenter" BackColor="#00A7A5" Font-Bold="true" ForeColor="#f5f5f5" />
                                            </asp:GridView>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label5" runat="server" Font-Bold="true" Text="VISA Settlement by International SERVICE USD"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="grid_visa_VSS" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                                <HeaderStyle CssClass="gvHeaderCenter" BackColor="#00A7A5" Font-Bold="true" ForeColor="#f5f5f5" />
                                            </asp:GridView>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label2" runat="server" Font-Bold="true" Text="VISA Payment Summary"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GetGrid_Visa_Smy" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                                <HeaderStyle CssClass="gvHeaderCenter" BackColor="#00A7A5" Font-Bold="true" ForeColor="#f5f5f5" />
                                            </asp:GridView>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label6" runat="server" Font-Bold="true" Text="VISA ITO Summary"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row user-control">
                                    <div class="col-md-12">
                                        ...
                                        <asp:LinkButton ID="Linkbtnexport" runat="server" class="btn btn-sm button_bg button3" OnClick="Linkbtnexport_Click"><i class="fa fa-file-excel-o fa-lg" aria-hidden="true" style="color:limegreen"></i> <span style ="color:white">Export</span></asp:LinkButton>
                                    </div>
                                </div>
                                <div class="row user-control">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label1" runat="server" Font-Bold="true" Text="VISA Payment listing"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GetGrid_Visa_list" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                                <HeaderStyle CssClass="gvHeaderCenter" BackColor="#00A7A5" Font-Bold="true" ForeColor="#f5f5f5" />
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <asp:Label ID="l_Wing" runat="server">GetCount :</asp:Label><asp:Label ID="l_count_VISA" runat="server" ForeColor="Blue"></asp:Label>
                                    </div>
                                </div>
