<%@ Page Language="C#" AutoEventWireup="true" CodeFile="custServiceAdd.aspx.cs" Inherits="CUSTOMERS_custServiceAdd" %>
        ...
        <div class="card card-default color-palette-box">
          <div class="card-header">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                         <asp:LinkButton ID="LinkAdd" runat="server" CssClass="btn btn-sm btn-primary" OnClick="LinkAdd_Click"><i class="fas fa-save" style="color:white" aria-hidden="true" ></i> ADD</asp:LinkButton>                   
            ...
            <div class="row user-control">
                ...
                <div class="col-md-3">
                    <asp:DropDownList ID= "D_PRODUCT" runat="server" CssClass="textboxstyle" AutoPostBack="true" OnSelectedIndexChanged="D_PRODUCT_SelectedIndexChanged"> </asp:DropDownList>
                </div>
                <div class="col-md-3">
                     SERVICEPACKAGE
                </div>
                <div class="col-md-3">
                     <asp:DropDownList ID= "D_SERCPKG" runat="server" CssClass="textboxstyle" Width="80%" AutoPostBack="true" OnSelectedIndexChanged="D_SERCPKG_SelectedIndexChanged"> </asp:DropDownList>
                </div>
            </div>
