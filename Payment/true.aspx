<%@ Page Language="C#" AutoEventWireup="true" CodeFile="true.aspx.cs" Inherits="Payment_true" %>
                                        ...
                                        <div class="box-body box-profile">
                                              <div class="box-header with-border">
                                                        <i class="fa fa-file-text"></i>
                                                         <h3 class="box-title" style="color:blue">True Money Settlement Dashboard</h3>
                                                     </div>
                                           ...
                                           <div class="row">
                                                <div class="col-md-12">
                                                       <iframe id="CSS_iframe"
                                                                style="border-style: none; width: 100%; height: 1155px;" src="True_Dashboard.aspx">
                                                            </iframe>
                                                  </div>
                                           </div>
