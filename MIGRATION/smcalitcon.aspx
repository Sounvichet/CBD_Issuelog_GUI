<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smcalitcon.aspx.cs" Inherits="MIGRATION_smcalitcon" %>
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <i class="fa fa-money"></i>
                                                <h3 class="box-title" style="color:blue">Summary Card listing Reconcile</h3>
                                            </div>
                                            <div class="box-body">
