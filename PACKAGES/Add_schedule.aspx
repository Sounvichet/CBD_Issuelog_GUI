<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_schedule.aspx.cs" Inherits="PACKAGES_Add_schedule" %>
            ...
            <div class="card-body">
                ...
                <table style="width:100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="D_SERVICEID" runat="server" CssClass="textboxstyle" Width="185px"></asp:DropDownList>
                        </td>
                        <td>
                           Schedule NO
                        </td>
                        <td>
                             <asp:TextBox ID="txtscheduleno" runat="server" CssClass="textboxstyle"></asp:TextBox>
                        </td>
                    </tr>
                </table>
