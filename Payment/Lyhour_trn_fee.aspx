<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Lyhour_trn_fee.aspx.cs" Inherits="Payment_Lyhour_trn_fee" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title" style="color:blue">Lyhour Transaction Settlement</h3>
                            </div>
                            <div class="box-body">
                                <asp:ScriptManager ID="SMSMBTOPUP" runat="server"></asp:ScriptManager>
                                <asp:UpdatePanel ID="UpdateMBTOPUP" UpdateMode="Conditional" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div class="row user-control">
                                                ...
                                                <div class="col-md-3">
                                                    <asp:DropDownList ID="d_settle_type" runat="server" CssClass="textboxstyle form-control">
                                            ...
                                            <div class="col-md-3">
                                                <asp:TextBox ID="txtUSDKHR" runat="server" CssClass="textboxstyle form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-md-3">
                                                THB <a class="fa fa-long-arrow-right"></a> KHR
                                            </div>
                                            <div class="col-md-3">
                                                <asp:TextBox ID="txtTHBKHR" runat="server" CssClass="textboxstyle form-control"></asp:TextBox>
                                            </div>
                                            </div>
                                            ...
                                            <div class="row user-control">
                                                ...
                                                <div class="col-md-3">
                                                    <asp:TextBox ID="txtupload" runat="server" CssClass="textboxstyle form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </ContentTemplate>
                                    <Triggers>
