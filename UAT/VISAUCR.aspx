<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VISAUCR.aspx.cs" Inherits="Payment_VISAUCR" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title" style="color: blue">Transaction Reference info</h3>
                            </div>
                            <div class="box-body">
                                    ...
                                    <ContentTemplate>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6" align="right">
                                                <asp:Label ID="Label1" runat="server" Text="REFNUM"></asp:Label>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="table-responsive">
                                                    <asp:GridView ID="grid1" DataKeyNames="REFNUM" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false" OnRowCommand="grid1_RowCommand" PageSize="10" AllowPaging="true">
