<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="Report_IncidentReport_index" %>
                            ...
                            <div class="col-xs-12">
                                   <div class="box box-primary">
                                        <div class="box-body box-profile">
                                              <div class="box-header with-border">
                                                        <i class="fa fa-file-text"></i>
                                                         <h3 class="box-title" style="color:blue">Report Incident Dashboard</h3>
                                                     </div>
                                       ...
                                       <div class="box-body">
                                           ...
                                           <div class="row">
                                                     <div class="col-md-3">
                                                        <asp:Label ID="L_report" runat="server" Text="Report Incident"></asp:Label>
                                                     </div>
                                                     <div class="col-md-3">
                                                        <asp:DropDownList ID="T_report_name" runat="server" class = "textboxstyle"> <%--Onclick="setSrcIFrame();"--%>
                                                        </asp:DropDownList>
                                                     </div>
                                                 </div>
                                           <p></p>
