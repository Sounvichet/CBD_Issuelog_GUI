<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new_biller_dispute.aspx.cs" Inherits="Payment_new_biller_dispute" %>
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row user-control">
                                            <div class="col-md-3">
                                                <asp:Label ID="Label8" runat="server" Text="CONSUMER_NO"></asp:Label>
                                            </div>
                                            <div class="col-md-3">
                                                <asp:TextBox ID="t_consumer_no" runat="server" CssClass="textboxstyle"></asp:TextBox>
                                            </div>
                                            <div class="col-md-3">
                                        ...
                                        <div class="row user-control">
                                            <div class="col-md-3">
                                                <asp:Label ID="Label17" runat="server" Text="CBS_REF"></asp:Label>
                                            </div>
                                            <div class="col-md-3">
                                                <asp:TextBox ID="t_cbs_ref" runat="server" CssClass="textboxstyle"></asp:TextBox>
                                            </div>
                                            <div class="col-md-3">
                                                <asp:Label ID="Label18" runat="server" Text="Partner_Name"></asp:Label>
                                            </div>
                                            <div class="col-md-3">
                                                <asp:TextBox ID="t_partner_name" runat="server" CssClass="textboxstyle"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row user-control">
                                            ...
                                            <div class="col-md-3">
                                             ...
                                             <div class="col-md-3">
                                                <asp:Label ID="Label2" runat="server" Text="Resolve_date"></asp:Label>
                                            </div>
                                            <div class="col-md-3">
                                                <asp:TextBox ID="t_resolve_date" runat="server" CssClass="textboxstyle"></asp:TextBox>
