<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CSSINDEX.aspx.cs" Inherits="Payment_CSSINDEX" %>
           ...
           $(function () {
               $("#D_serviceType").change(function () {
                   ...
                   var selectedValue = $(this).val();
                       ...
                       if (dropdownValue == '.aspx')
                       {
                           document.getElementById("CSS_iframe").src = 'CSS_Dashboard.aspx';
                       }
                       else
                       {
                           var getmainfolder;
                           document.getElementById("CSS_iframe").src = dropdownValue;
                           //getmainfolder = 'Payment/' + dropdownValue;
                           //localStorage.setItem("url", getmainfolder);
                                        ...
                                        <div class="box-body box-profile">
                                              <div class="box-header with-border">
                                                        <i class="fa fa-file-text"></i>
                                                         <h3 class="box-title" style="color:blue">CSS Settlement Dashboard</h3>
                                                     </div>
                                           ...
                                           <div class="row">
                                                <div class="col-md-12">
                                                       <iframe id="CSS_iframe"
                                                                style="border-style: none; width: 100%; height: 1155px; border: 0;" src="CSS_Dashboard.aspx">
                                                            </iframe>
                                                  </div>
                                           </div>
