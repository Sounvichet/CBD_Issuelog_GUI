<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TBSWUPLD.aspx.cs" Inherits="Payment_TBSWUPLD" %>
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <i class="fa fa-money"></i>
                                                <h3 class="box-title" style="color:blue">Upload Wing listing Reconcile</h3>
                                            </div>
                                            <div class="box-body">
