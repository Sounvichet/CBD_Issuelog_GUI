<%@ Page Language="C#" AutoEventWireup="true" CodeFile="summary.aspx.cs" Inherits="MIGRATION_summary" %>
                                        ...
                                        <div class="box-body box-profile">
                                              <div class="box-header with-border">
                                                        <i class="fa fa-file-text"></i>
                                                         <h3 class="box-title" style="color:blue">BO Data Verification</h3>
                                                     </div>
                                           ...
                                           <div class="row">
                                                <div class="col-md-12">
                                                       <iframe id="CSS_iframe"
                                                                style="border-style: none; width: 100%; height: 1155px; border: 0;" src="migration_dashboard.aspx">
                                                            </iframe>
                                                  </div>
                                           </div>
