<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cashback_index.aspx.cs" Inherits="Payment_cashback_index" %>
           ...
           $(function () {
               $("#D_serviceType").change(function () {
                   ...
                   var selectedValue = $(this).val();
                       ...
                       if (dropdownValue == '.aspx')
                       {
                           document.getElementById("CSS_iframe").src = 'cashback_Dashboard.aspx';
                       }
                       else
                       {
                                        ...
                                        <div class="box-body box-profile">
                                              <div class="box-header with-border">
                                                        <i class="fa fa-file-text"></i>
                                                         <h3 class="box-title" style="color:blue">CASHBACK VISA Dashboard</h3>
                                                     </div>
                                           ...
                                           <div class="row">
                                                <div class="col-md-12">
                                                       <iframe id="CSS_iframe"
                                                                style="border-style: none; width: 100%; height: 1155px;" src="cashback_Dashboard.aspx">
                                                            </iframe>
                                                  </div>
                                           </div>
