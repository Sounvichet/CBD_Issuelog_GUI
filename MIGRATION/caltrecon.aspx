<%@ Page Language="C#" AutoEventWireup="true" CodeFile="caltrecon.aspx.cs" Inherits="MIGRATION_caltrecon" %>
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <i class="fa fa-credit-card"></i>
                                                <h3 class="box-title" style="color:blue">Card Listing Reconcile</h3>
                                            </div>
                                            <div class="box-body">
