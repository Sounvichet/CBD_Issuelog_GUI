<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nodedowntype.aspx.cs" Inherits="Reportchart_nodedowntype" %>
                             ...
                             <div class="box box-primary">
                                     ...
                                     <div class="box-header with-border">
                                         <i class="fa fa-ticket"></i>
                                                 <h3 class="box-title" style="color:blue">NodeDown Group reason</h3>
                                             </div>
                                       <div class="box-body">
                                ...
                                <asp:UpdatePanel ID="Updateticketindex" UpdateMode="Conditional" runat="server">
                                           ...
                                           <div class="row">
                                               <div class="col-md-6">
                                                   ...
                                                   <asp:LinkButton ID="Linkbtnmodify" runat="server" CssClass="btn btn-sm btn-primary" OnClick="Linkbtnmodify_Click"><i class="fa fa-pencil-square-o fa-lg" style="color:red" aria-hidden="true" ></i> Modify</asp:LinkButton>
                                               </div>
                                               <p></p>
                                           ...
                                           <div class="row">
                                               <div class="col-lg-12">
                                                  <div class ="table-responsive">
                                                        <asp:GridView ID="grid1" DataKeyNames ="GrouptypeID" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false"  onpageindexchanging="grid1_PageIndexChanging" PageSize="10" AllowPaging="true">
