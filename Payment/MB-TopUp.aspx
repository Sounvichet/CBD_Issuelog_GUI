<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MB-TopUp.aspx.cs" Inherits="Payment_MB_TopUp" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title" style="color:blue">MB Top-Up Settlement</h3>
                            </div>
                            <div class="box-body">
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="row user-control">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-6">USD To KHR</div>
                                                    <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-6">THB To KHR:</div>
                                                    <div class="col-md-6">
                                                        <asp:TextBox runat="server" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
