<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CSSRPT.aspx.cs" Inherits="Payment_CSSRPT" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title" style="color: blue">3-Insert Settlement Record</h3>
                            </div>
                            <div class="box-body">
                                    ...
                                    <div class="col-md-12">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <button id="btnExport" runat="server" onserverclick="btnExport_ServerClick" class="btn btn-sm btn-primary button_bg">
                                                        <i class="fa fa-file-excel-o fa-lg" aria-hidden="true" style="color: limegreen"></i>Export</button>
