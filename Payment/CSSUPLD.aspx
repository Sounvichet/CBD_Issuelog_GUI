<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CSSUPLD.aspx.cs" Inherits="Payment_CSSUPLD" %>
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <table>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                  <Button ID="btnUpload" runat="server" onserverclick="btnUpload_Click" onclick ="$('#loading').show();" class="btn btn-sm btn-primary button_bg">Apply</Button>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>
