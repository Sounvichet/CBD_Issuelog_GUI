<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smcreftcon.aspx.cs" Inherits="MIGRATION_smcreftcon" %>
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <i class="fa fa-money"></i>
                                                <h3 class="box-title" style="color:blue">Summary Cref FE Reconcile</h3>
                                            </div>
                                            <div class="box-body">
