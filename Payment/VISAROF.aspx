                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row user-control">
                                    <div class="col-md-6">
                                        <asp:LinkButton ID="linkbtnprocess" runat="server" CssClass="btn btn-sm button_bg" OnClick ="linkbtnprocess_Click" OnClientClick="showLoading();"><i class="fa fa-solid fa-rotate-right fa-lg" style="color:white" aria-hidden="true"></i> <span style="color:white">Process</span> </asp:LinkButton>
                                   </div>
                                </div>
                                ...
                                <div class="row user-control">
                                    ...
                                    <div class="col-md-3">
                                        <asp:TextBox ID="t_gl_ending_balance" runat="server" CssClass="textboxstyle"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="row user-control">
                                    ...
                                    <div class="col-md-3">
                                        <asp:TextBox ID="t_cal_right_off" runat="server" CssClass="textboxstyle"></asp:TextBox>
                                    </div>
                                    <div class="col-md-3">
                                         <asp:Label ID="Label3" runat="server" Text="DR/CR"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <asp:TextBox ID="t_dr_cr" runat="server" CssClass="textboxstyle"></asp:TextBox>
                                    </div>
                                </div>
