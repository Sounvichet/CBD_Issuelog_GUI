...
public partial class Reportchart_solarwindstm : System.Web.UI.Page
{
    ...
    SolarWindSTMDashboard _solarWind = new SolarWindSTMDashboard();
    ...
    {
        DataTable dt = _solarWind.D_CurSTMdownPercent();
        string _ID = "";
        if (dt.Rows.Count > 1)
        {
    ...
    protected void grid1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "lnkedit")
        {
            ...
            Response.Redirect("~/Reportchart/NodeGroupReason.aspx?EventID=" + row.Cells[2].Text + "&Channel=STM"); //"&ReasonGroup=" + row.Cells[6].Text +"&ReasonType="+ row.Cells[7].Text);
        }
    ...
    {
        _gridView._GridviewBinding(GridView1, _rptsolarwind.D_STMNodeDownMinute(D_BranchName.SelectedValue, D_NodeName.SelectedValue, T_Form.Text, T_To.Text));
        Label8.Text = GridView1.Rows.Count.ToString();
    }
