<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VISACDI.aspx.cs" Inherits="Payment_VISACDI" %>
                             ...
                             <div class="box box-primary">
                                     ...
                                     <div class="box-header with-border">
                                         <i class="fas fa-file-invoice"></i>
                                                 <h3 class="box-title" style="color:blue">VISA Case disputes</h3>
                                             </div>
                                       <div class="box-body">
                                ...
                                <asp:UpdatePanel ID="Updateticketindex" UpdateMode="Conditional" runat="server">
                                           ...
                                           <div class="row">
                                               <div class="col-md-6">
                                                   ...
                                                   <asp:LinkButton ID="LinkbtnExport" runat="server" CssClass="btn btn-sm btn-primary button_bg" OnClick="btn_apply_Click" Visible="false"><i class="fa fa-file-excel-o fa-lg" style="color:red" aria-hidden="true" ></i> Export</asp:LinkButton>
                                                   <asp:LinkButton ID="LinkbtnReport" runat="server" CssClass="btn btn-sm btn-primary button_bg" OnClick="LinkbtnReport_Click" Visible="false"><i class="fa fa-list fa-lg" style="color:deeppink" aria-hidden="true" ></i> Report</asp:LinkButton>
                                               </div>
                                           </div>
                                           ...
                                           <div class="row">
                                               <div class="col-lg-12">
                                                  <div class ="table-responsive">
                                                        <asp:GridView ID="grid1" DataKeyNames="refnum" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false" OnRowCommand="grid1_RowCommand" onpageindexchanging="grid1_PageIndexChanging" PageSize="10" AllowPaging="true">
