<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete.aspx.cs" Inherits="Mission_delete" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header">
                                <h3 class="box-title">Delete mission</h3>
                            </div>
                            <div class="box-body">
                                    ...
                                    <ContentTemplate>
                                        <div class="row">
                                            <div class="col-md-12" align="left">
                                                <asp:LinkButton ID="Linkbtndelete" runat="server" CssClass="btn btn-sm btn-primary button_bg button3" OnClick="Btndelete_Click"><i class="fa fa-save fa-lg" aria-hidden="true" ></i> Delete</asp:LinkButton>
