<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CASHWFL.aspx.cs" Inherits="Payment_CASHWFL" %>
   ...
   <%-- <script type="text/javascript">
    ...
    <script type="text/javascript">
        function RadioCheck(rb) {
            var gv = document.getElementById("<%=GetGrid_cashback_Visa_list.ClientID%>");
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title" style="color: blue">CASHBACK VISA Payment</h3>
                            </div>
                            <div class="box-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:DropDownList ID="d_settlement" CssClass="textboxstyle" runat="server">
                                                        <asp:ListItem>CASHBACK VISA PAYMENT</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                                <%--<td>
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label2" runat="server" Font-Bold="true" Text="CASHBACK VISA Payment Summary"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GetGrid_CASHBACK_Smy" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GetGrid_cashback_Visa_list" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                                <HeaderStyle CssClass="gvHeaderCenter" BackColor="#00A7A5" Font-Bold="true" ForeColor="#f5f5f5" />
