...
public partial class Payment_PMSCST : System.Web.UI.Page
{
    ...
    protected void btnedit_click(object sender, EventArgs e)
    {
        foreach (GridViewRow row in grid1.Rows)
        {
            ...
            if (checkbox.Checked)
            {
                ...
                Response.Redirect("~/Payment/edit_fee_maintenance.aspx?card_id=" + id);
            }
        }
    }
    ...
    protected void grid1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "lnkedit")
        {
            ...
            Response.Redirect("~/Payment/edit_fee_maintenance.aspx?card_id=" + row.Cells[1].Text);
        }
    }
