<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VISACAU.aspx.cs" Inherits="Payment_VISACAU" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title" style="color: blue">VISA Payment Customer account settlement re-upload</h3>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label3" runat="server" Font-Bold="true" Text="List of all Transaction VSS & NNSS"></asp:Label>
                                    </div>
                                </div>
