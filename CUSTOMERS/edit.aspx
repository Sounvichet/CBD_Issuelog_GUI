<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit.aspx.cs" Inherits="CUSTOMERS_edit" %>
                      ...
                      <div class="container-fluid">
                        ...
                        <div class="card card-default color-palette-box">
                         ...
                         <div class="card-body">
                             ...
                             <div class="row">
                                <div class="col-md-6">
                                    <asp:LinkButton ID="linkedit" runat="server" CssClass="btn btn-sm btn-primary" OnClick="linkedit_Click" ><i class="fa fa-save" style="color:white" aria-hidden="true"></i> Edit</asp:LinkButton>
                             ...
                             <div class="row user-control">
                                 ...
                                 <div class="col-md-3">
                                     <asp:Label ID="l_branchID" runat="server" ForeColor="Blue"></asp:Label>
                                 </div>
                                 <div class="col-md-3">
                                     CustomerID 
                                 </div>
                                 <div class="col-md-3">
                                     <asp:Label ID="l_customerid" runat="server" ForeColor="Blue"></asp:Label>
                                 </div>
                             </div>
                             ...
                             <div class="row user-control">
                                 ...
                                 <div class="col-md-3">
                                 <asp:TextBox ID="t_fullname" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                                 </div>
                                 <div class="col-md-3">
                                     Email<span style="color:red">*</span>
                                 </div>
                                 <div class="col-md-3">
                                     <asp:TextBox ID="t_email" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                                 </div>
                             </div>
                              ...
                              <div class="row user-control">
                                 ...
                                 <div class="col-md-3">
                                     <asp:TextBox ID="T_FName" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                                 </div>
                                 <div class="col-md-3">
                                     Last Name<span style="color:red">*</span>
                                 </div>
                                 <div class="col-md-3">
                                     <asp:TextBox ID="T_Lname" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                                 </div>
                             </div>
                              ...
                              <div class="row user-control">
                                 ...
                                 <div class="col-md-3">
                                     <asp:Label ID="l_cycle" runat="server" ForeColor="Blue"></asp:Label>
                                 </div>
                                 <div class="col-md-3">
                                     Out standing
                                 </div>
                                 <div class="col-md-3">
                                     <asp:Label ID="l_standing" runat="server" ForeColor="Blue"></asp:Label>
                                 </div>
                             </div>
                              ...
                              <div class="row user-control">
                                 ...
                                 <div class="col-md-3">
                                     <asp:TextBox ID="T_phone" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                                 </div>
                                 <div class="col-md-3">
                                     #house<span style="color:red">*</span>
                                 </div>
                                 <div class="col-md-3">
                                     <asp:TextBox ID="T_house" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                                 </div>
                             </div>
                              ...
                              <div class="row user-control">
                                 ...
                                 <div class="col-md-3">
                                     <asp:TextBox ID="T_street" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                                 </div>
                                 <div class="col-md-3">
                                     Village<span style="color:red">*</span>
                                 </div>
                                 <div class="col-md-3">
                                     <asp:TextBox ID="T_village" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                                 </div>
                             </div>
                             ...
                             <div class="row user-control">
                                 ...
                                 <div class="col-md-3">
                                     <asp:TextBox ID="T_Commune" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                                 </div>
                                 <div class="col-md-3">
                                     District<span style="color:red">*</span>
                                 </div>
                                 <div class="col-md-3">
                                     <asp:TextBox ID="T_District" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                                 </div>
                             </div>
                             ...
                             <div class="row user-control">
                                 ...
                                 <div class="col-md-3">
                                     <asp:TextBox ID="T_Province" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                                 </div>
                                 <div class="col-md-3">
                                     DOB
                                 </div>
                                 <div class="col-md-3">
                                     <asp:TextBox ID="T_DOB" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                                 </div>
                             </div>
