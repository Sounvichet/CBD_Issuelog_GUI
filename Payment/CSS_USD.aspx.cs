...
public partial class Payment_CSS_USD : System.Web.UI.Page
{
    ...
    {
       // _grid._GridviewBinding(GridView1, _CSS._get_CSS_SETTLEMENT("30-Jul-2020", "USD"));

    }

    //private void getcsstotal()
    //{
    //    DataTable dt = _CSS._get_CSS_SETTLEMENT(getdate, "USD");
