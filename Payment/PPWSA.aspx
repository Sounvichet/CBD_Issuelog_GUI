<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PPWSA.aspx.cs" Inherits="Payment_PPWSA" %>
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <i class="fa fa-money"></i>
                                                <h3 class="box-title" style="color:blue">PPWSA Settlement</h3>
                                            </div>
                                            <div class="box-body">
                                ...
                                <asp:UpdatePanel ID="UpdatePPWSA" UpdateMode="Conditional" runat="server">
			                                <ContentTemplate> 
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">    
                                                        <asp:TextBox ID="txtForm" runat="server" CssClass="textboxstyle form-control"></asp:TextBox>
                                                     </div>
                                                    <div class="col-md-3">
                                                        Generate :
                                                     </div>
                                                    <div class="col-md-3">
                                                        <asp:TextBox ID="txtgenerate" runat="server" CssClass="textboxstyle form-control" Enabled="false"></asp:TextBox>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row user-control">
                                                    ...
                                                    <div class="col-md-3">
                                                        <asp:DropDownList ID="D_selectdate" runat="server" CssClass="textboxstyle form-control" AutoPostBack="true" OnSelectedIndexChanged="D_selectdate_SelectedIndexChanged"></asp:DropDownList>
                                                    </div>
                                                </div>
