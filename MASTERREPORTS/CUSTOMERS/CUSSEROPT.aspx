<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CUSSEROPT.aspx.cs" Inherits="MASTERREPORTS_CUSTOMERS_CUSSEROPT" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="row user-control">
            <div class="col-md-12 table-responsive">
                            <asp:GridView ID="GridCustreport"  CssClass="table-bordered table-hover gridgetsize"  runat="server" Width="100%"  AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false" >
