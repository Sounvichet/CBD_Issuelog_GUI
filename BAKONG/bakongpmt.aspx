<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bakongpmt.aspx.cs" Inherits="Payment_bakongpmt" %>
           ...
           $(function () {
               $("#D_serviceType").change(function () {
                   ...
                   var selectedValue = $(this).val();
                       ...
                       if (dropdownValue == '.aspx')
                       {
                           document.getElementById("BAKONG_iframe").src = 'Bakong_Dashboard.aspx';
                       }
                       else
                       {
                           document.getElementById("BAKONG_iframe").src = dropdownValue;
                       }
                            ...
                            <div class="col-xs-12">
                                   <div class="box box-primary">
                                        <div class="box-body box-profile">
                                              <div class="box-header with-border">
                                                        <i class="fa fa-file-text"></i>
                                                         <h3 class="box-title" style="color:blue">Bakong Clearing Dashboard</h3>
                                                     </div>
                                       ...
                                       <div class="box-body">
                                           ...
                                           <div class="row">
                                                <div class="col-md-12">
                                                       <iframe id="BAKONG_iframe"
                                                                style="border-style: none; width: 100%; height: 1155px;" src="Bakong_Dashboard.aspx">
                                                            </iframe>
                                                  </div>
                                           </div>
