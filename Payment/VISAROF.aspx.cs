...
public partial class Payment_VISAROF : System.Web.UI.Page
{
    ...
    WriteOffDashboard _visa = new WriteOffDashboard();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            _drop.bindDropDownList(d_GL_account,_visa._get_GL_ACCT_WRITE_OFF());
    ...
    {
        decimal gl_balance = Convert.ToDecimal(t_gl_ending_balance.Text);
        decimal visa_balance = Convert.ToDecimal(t_ending_balance.Text);
        t_cal_right_off.Text = Convert.ToString(visa_balance - gl_balance);

        decimal cal_right_off = Convert.ToDecimal(t_cal_right_off.Text);
    ...
    public bool _register_visa_right_off()
    {
        ...
        {
            ShowMessage("added visa right off is fail!" + _visa._get_message, MessageType.Error);
        }
