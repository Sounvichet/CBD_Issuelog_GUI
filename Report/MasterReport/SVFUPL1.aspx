<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SVFUPL1.aspx.cs" Inherits="Report_MasterReport_SVFUPL1" %>
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <i class="fa fa-money"></i>
                                                <h3 class="box-title" style="color:blue">Upload Card 90days listing</h3>
                                            </div>
                                            <div class="box-body">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <table>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                  <asp:Button ID="btnUpload" runat="server" Text="Upload" OnClick="btnUpload_Click" OnClientClick ="$('#loading').show();" Enabled="true" CssClass="btn btn-sm btn-primary button_bg" /> 
                                                                                            </td>
