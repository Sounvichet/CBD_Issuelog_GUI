<%@ Page Language="C#" AutoEventWireup="true" CodeFile="uploadfile.aspx.cs" Inherits="Report_MasterReport_uploadfile" %>
                                        ...
                                        <div class="box-body box-profile">
                                              <div class="box-header with-border">
                                                        <i class="fa fa-upload"></i>
                                                         <h3 class="box-title" style="color:blue">Upload file Dashboard</h3>
                                                     </div>
                                           ...
                                           <div class="row">
                                                <div class="col-md-12">
                                                       <iframe id="CSS_iframe"
                                                                style="border-style: none; width: 100%; height: 1155px;" src="upload_Dashboard.aspx">
                                                            </iframe>
                                                  </div>
                                           </div>
