<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CSSWFL.aspx.cs" Inherits="Payment_CSSWFL" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function ShowMessage(message, messagetype) {
            ...
            setTimeout(function () {
                $("#alert_div").fadeTo(10000, 500).slideUp(500, function () {
                    $("#alert_div").remove();
                });
            }, 5000);//5000=5 seconds
        };
    ...
    <script type="text/javascript">
        function RadioCheck(rb) {
            var gv = document.getElementById("<%=GetGrid_css_list.ClientID%>");
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title" style="color: blue">CSS Payment</h3>
                            </div>
                            <div class="box-body">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:DropDownList ID="d_settlement" CssClass="textboxstyle" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label3" runat="server" Font-Bold="true" Text="CSS Settlement by Currency USD"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="grid_css_sttl_USD" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label4" runat="server" Font-Bold="true" Text="CSS Settlement by Currency KHR"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="grid_css_sttl_KHR" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                                <HeaderStyle CssClass="gvHeaderCenter" BackColor="#00A7A5" Font-Bold="true" ForeColor="#f5f5f5" />
                                            </asp:GridView>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label2" runat="server" Font-Bold="true" Text="CSS Payment Summary"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GetGrid_CSS_Smy" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                                <HeaderStyle CssClass="gvHeaderCenter" BackColor="#00A7A5" Font-Bold="true" ForeColor="#f5f5f5" />
                                            </asp:GridView>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label6" runat="server" Font-Bold="true" Text="CSS ITO Summary"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="Grid_ITO_SMY" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                                <HeaderStyle CssClass="gvHeaderCenter" BackColor="#00A7A5" Font-Bold="true" ForeColor="#f5f5f5" />
                                            </asp:GridView>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label5" runat="server" Font-Bold="true" Text="CSS Check Settlement Variance"></asp:Label>
                                    </div>
                                </div>
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="Grid_check_variance" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                                <HeaderStyle CssClass="gvHeaderCenter" BackColor="#00A7A5" Font-Bold="true" ForeColor="#f5f5f5" />
                                            </asp:GridView>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label7" runat="server" Font-Bold="true" Text="CSS Total count by Status"></asp:Label>
                                    </div>
                                </div>
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="Grid_total_count_status" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                                <HeaderStyle CssClass="gvHeaderCenter" BackColor="#00A7A5" Font-Bold="true" ForeColor="#f5f5f5" />
                                            </asp:GridView>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label8" runat="server" Font-Bold="true" Text="CSS Not Booking CBS"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="Grid_cbs_no_booking" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                                <HeaderStyle CssClass="gvHeaderCenter" BackColor="#00A7A5" Font-Bold="true" ForeColor="#f5f5f5" />
                                            </asp:GridView>
                                        </div>
                                    </div>
                                ...
                                <div class="row user-control">
                                    <div class="col-md-12">
                                        <%--<asp:LinkButton ID="Linkbtnupdate" runat="server" class="btn btn-sm btn-primary button_bg" onclick="btnedit_click"  ><i class="fa fa-pencil fa-lg" aria-hidden="true"></i> Edit</asp:LinkButton>
                                                                                    <asp:LinkButton ID="linkbtndelete" runat="server" class="btn btn-sm btn-primary button_bg"  onclick="btndelete_click" ><i class="fa fa-times fa-lg" aria-hidden="true" style="color:red"></i> Delete</asp:LinkButton>--%>
                                        <asp:LinkButton ID="Linkbtnexport" runat="server" class="btn btn-sm btn-primary button_bg" OnClick="Linkbtnexport_Click"><i class="fa fa-file-excel-o fa-lg" aria-hidden="true" style="color:limegreen"></i> Export</asp:LinkButton>
                                    </div>
                                </div>
                                <div class="row user-control">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label1" runat="server" Font-Bold="true" Text="CSS Payment listing"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GetGrid_css_list" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false">
                                                <HeaderStyle CssClass="gvHeaderCenter" BackColor="#00A7A5" Font-Bold="true" ForeColor="#f5f5f5" />
                                                ...
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            ...
                                                            <asp:Label ID="l_checkbox" runat="server">CHECKBOX</asp:Label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <asp:Label ID="l_Wing" runat="server">GetCount :</asp:Label><asp:Label ID="l_count_css" runat="server" ForeColor="Blue"></asp:Label>
                                    </div>
                                </div>
