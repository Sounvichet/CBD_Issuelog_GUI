<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smacqcon.aspx.cs" Inherits="MIGRATION_smacqcon" %>
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <i class="fa fa-money"></i>
                                                <h3 class="box-title" style="color:blue">Summary Acquiring Reconcile</h3>
                                            </div>
                                            <div class="box-body">
