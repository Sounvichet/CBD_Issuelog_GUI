...
public partial class Payment_CSSWFL : System.Web.UI.Page
{
    ...
    private void _grid_css_ito_pre()
    {
        ...
        _grid._GridviewBinding(GetGrid_css_list, _pre._CSS_OBS_Settlement());
        l_count_css.Text = GetGrid_css_list.Rows.Count.ToString();

    }

    private void _grid_css_ito_smy()
    {
        _pre.P_CCY = d_settlement.SelectedItem.Text;
        _pre.P_SDATE = t_start_date.Text;
        _pre.P_EDATE = t_end_date.Text;
        ...
        _grid._GridviewBinding(Grid_ITO_SMY, _pre._CSS_ITO_SMY());
    ...
    private void _grid_css_getcount_CBS_Not_Booking()
    {
        _pre.P_CCY = d_settlement.SelectedItem.Text;
        _pre.P_SDATE = t_start_date.Text;
        _pre.P_EDATE = t_end_date.Text;
        Grid_cbs_no_booking.HeaderStyle.BackColor = Color.FromName("#00A7A5");
        Grid_cbs_no_booking.HeaderStyle.Font.Bold = true;
        Grid_cbs_no_booking.HeaderStyle.ForeColor = Color.FromName("#f5f5f5");
        _grid._GridviewBinding(Grid_cbs_no_booking, _css._CSS_NBC_get_count_by_CBS_Not_Booking());
    ...
    {
        _grid_css_obs_settlement_USD();
        _grid_css_obs_settlement_KHR();
        _grid_css_ito_pre();
        _grid_css_ito_smy();
        _grid_css_payment_smy();
        _grid_css_check_variance();
        _grid_css_getcount_by_status();
        _grid_css_getcount_CBS_Not_Booking();
    }
