...
public partial class MIGRATION_smcalitcon : System.Web.UI.Page
{
    ...
    public void _ExportGenerate()
    {
        ...
        DataTable dt1 = _mig.D_get_card_listing_summary_recon();
        workbook.Worksheets.Add(dt1, "Card_list_smy");
        Response.Clear();
        Response.Buffer = true;
        Response.Charset = "";
        Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
        Response.AddHeader("content-disposition", "attachment;filename=Card_list_smy"+ _mig._P_F_BRN + "_"+ _mig._P_T_BRN + ".xlsx");
