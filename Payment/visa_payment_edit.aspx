<%@ Page Language="C#" AutoEventWireup="true" CodeFile="visa_payment_edit.aspx.cs" Inherits="Payment_visa_payment_edit" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header">
                                <h3 class="box-title" style="color: blue">VISA Payment Edit</h3>
                            </div>
                            <div class="box-body">
                                ...
                                <asp:UpdatePanel ID="UpdatevistaEdit" UpdateMode="Conditional" runat="server">
                                    <ContentTemplate>--%>
                                        <div class="row user-control">
                                            <div class="col-md-12">
                                                <asp:LinkButton ID="Linkbtnedit" runat="server" CssClass="btn btn-sm btn-primary button_bg" OnClientClick="enable_button();" OnClick="Linkbtnedit_Click"><i class="fa fa-pencil fa-lg" aria-hidden="true" style="color:orangered"></i> Edit</asp:LinkButton>
                                                <asp:LinkButton ID="Linkbtnsave" runat="server" CssClass="btn btn-sm btn-primary button_bg" Enabled="false" OnClick="Linkbtnsave_Click"><i class="fa fa-save fa-lg" aria-hidden="true" style="color:forestgreen" ></i> Save</asp:LinkButton>
                                        ...
                                        <div class="row user-control">
                                            ...
                                            <div class="col-md-3">
                                                <asp:TextBox ID="t_AMOUNT" runat="server" CssClass="textboxstyle"  OnTextChanged="t_AMOUNT_TextChanged" AutoPostBack="true" Enabled="false"></asp:TextBox>
                                            ...
                                            <div class="col-md-3">
                                                <asp:TextBox ID="t_LCY_AMOUNT" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                                            </div>
                                        </div>
                                       <%-- <div class="row user-control">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                 <asp:RegularExpressionValidator id ="RegularExpressionValidator1" ControlToValidate ="t_AMOUNT" runat="server"
                                   ...
                                   <%-- </ContentTemplate>
                                     <Triggers>
                                                                                <asp:PostBackTrigger ControlID="t_AMOUNT" />
                                                                                 <asp:PostBackTrigger ControlID="t_LCY_AMOUNT" />
                                     </Triggers>
                                </asp:UpdatePanel>--%>
                            </div>
                        </div>
