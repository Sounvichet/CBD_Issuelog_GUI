<%@ Page Language="C#" AutoEventWireup="true" CodeFile="getcustimage.aspx.cs" Inherits="CUSTOMERS_getcustimage" %>
    ...
    <form id="form1" runat="server">
                                             <div class="box-header">
                                              ...
                                              <div class="box-body">
                                                  ...
                                                  <div class="row user-control">
                                                      <div class="col-md-12">
                                                          <asp:LinkButton ID="LinkAction" runat="server" CssClass="btn btn-sm btn-primary" OnClick="LinkAction_Click"><i class="fas fa-save" style="color:white" aria-hidden="true" ></i> Save</asp:LinkButton> 
                                                      </div>
                                                  </div>
                                              </div>
    </form>
