<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smtcptcon.aspx.cs" Inherits="MIGRATION_smtcptcon" %>
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <i class="fa fa-money"></i>
                                                <h3 class="box-title" style="color:blue">Summary TCP TAB FE Reconcile</h3>
                                            </div>
                                            <div class="box-body">
