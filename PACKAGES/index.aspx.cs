...
public partial class PACKAGES_index : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("~/PACKAGES/new.aspx");
    }
    protected void Linkbtnedit_Click1(object sender, EventArgs e)
    {
        foreach (GridViewRow row in grid1.Rows)
        {
            ...
            if (checkbox.Checked)
            {
                ...
                Response.Redirect("~/PACKAGES/edit.aspx?PACKAGEID=" + id);
            }
    ...
    protected void LinkBtndel_Click(object sender, EventArgs e)
    {
        foreach (GridViewRow row in grid1.Rows)
        {
            ...
            {
                string id = Convert.ToString(row.Cells[4].Text);
                Response.Redirect("~/PACKAGES/delete.aspx?PACKAGEID=" + id);
            }
    ...
    {
        _grid._GridviewBinding(grid1, _PKG._getPackagesListing());
        Label4.Text = grid1.Rows.Count.ToString();
    }
    ...
    private void _getexcel_Packagetype()
    {
        try
        {
            ...
            dt = _PKG._getPackagesListing();
            wb.Worksheets.Add(dt, "PackageType");
            Response.Clear();
            Response.Buffer = true;
            Response.Charset = "";
            Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
            Response.AddHeader("content-disposition", "attachment;filename=PackageType.xlsx");
