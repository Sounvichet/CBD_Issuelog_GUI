<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index_Maintenance_FEE.aspx.cs" Inherits="Payment_index_Maintenance_FEE" %>
           ...
           $(function () {
               $("#D_serviceType").change(function () {
                   ...
                   var selectedValue = $(this).val();
                       ...
                       if (dropdownValue == '.aspx')
                       {
                           document.getElementById("Maintenance_iframe").src = 'IncidentDashboard.aspx';
                       }
                       else
                       {
                           document.getElementById("Maintenance_iframe").src = dropdownValue;
                       }
                                        ...
                                        <div class="box-body box-profile">
                                              <div class="box-header with-border">
                                                        <i class="fa fa-file-text"></i>
                                                         <h3 class="box-title" style="color:blue">Maintenance Fee Dashboard</h3>
                                                     </div>
                                       ...
                                       <div class="box-body">
                                           ...
                                           <div class="row">
                                                <div class="col-md-12" style="width:100%;height:800px;">
                                                       <iframe id="Maintenance_iframe"
                                                                style="border-style: none; width: 100%; height: 100%; border: 0;">
                                                            </iframe>
                                                  </div>
                                           </div>
