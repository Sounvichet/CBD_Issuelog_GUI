<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Solid_waste.aspx.cs" Inherits="Payment_Solid_waste" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title" style="color:blue">Solid Waste Settlement</h3>
                            </div>
                            <div class="box-body">
                                <asp:ScriptManager ID="SMSSOLID" runat="server"></asp:ScriptManager>
                                <asp:UpdatePanel ID="UpdateSOLID" UpdateMode="Conditional" runat="server">
                                        <ContentTemplate>
                                          ...
                                          <%--  <div class="row user-control">
                                                ...
                                                <div class="col-md-3">
                                                    <asp:DropDownList ID="d_curr" runat="server" CssClass="textboxstyle form-control">
