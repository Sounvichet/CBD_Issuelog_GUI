<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TBSWDNEW.aspx.cs" Inherits="Payment_TBSWDNEW" %>
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <i class="fa fa-money"></i>
                                                <h3 class="box-title" style="color:blue">Insert Wing Disputed Resolution</h3>
                                            </div>
                                            <div class="box-body">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <table>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                  <asp:Button ID="btnUpload" runat="server" Text="Apply" OnClick="btnUpload_Click" Enabled="true" CssClass="btn btn-sm btn-primary" /> 
