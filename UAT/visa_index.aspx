<%@ Page Language="C#" AutoEventWireup="true" CodeFile="visa_index.aspx.cs" Inherits="Payment_visa_index" %>
                                        ...
                                        <div class="box-body box-profile">
                                              <div class="box-header with-border">
                                                        <i class="fa fa-file-text"></i>
                                                         <h3 class="box-title" style="color:blue">VISA Clearing UAT Dashboard</h3>
                                                     </div>
                                           ...
                                           <div class="row">
                                                <div class="col-md-12">
                                                       <iframe id="CSS_iframe"
                                                                style="border-style: none; width: 100%; height: 1155px;" src="VISA_Dashboard.aspx">
                                                            </iframe>
                                                  </div>
                                           </div>
