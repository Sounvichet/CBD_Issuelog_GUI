<%@ Page Language="C#" AutoEventWireup="true" CodeFile="biller_disp_index.aspx.cs" Inherits="Payment_biller_disp_index" %>
                             ...
                             <div class="box box-primary">
                                     ...
                                     <div class="box-header with-border">
                                         <i class="fas fa-file-invoice"></i>
                                                 <h3 class="box-title" style="color:blue">Biller dispute Pending</h3>
                                             </div>
                                       <div class="box-body">
                                           ...
                                           <div class="row">
                                               <div class="col-lg-12">
                                                  <div class ="table-responsive">
                                                        <asp:GridView ID="grid1" DataKeyNames="original_ref" CssClass="table table-bordered table-hover" runat="server" Font-Size="11px" AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false" OnRowCommand="grid1_RowCommand" onpageindexchanging="grid1_PageIndexChanging" PageSize="10" AllowPaging="true">
