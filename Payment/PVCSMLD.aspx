<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PVCSMLD.aspx.cs" Inherits="Payment_PVCSMLD" %>
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <i class="fa fa-plug"></i>
                                                <h3 class="box-title" style="color:blue">PRIVATE EDC CONSUMER</h3>
                                            </div>
                                            <div class="box-body">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <a href="javascript:;" id="testClick"></a>
                                                                    ...
                                                                    <div class="loading-content">
                                                                        <p style="color: #ffffff;">Proccessing...</p>
                                                ...
                                                <div class="row user-control">
                                                        <div class="col-md-12">
                                                                <button ID="Linkbtnproccess" runat="server" Class="btn btn-sm btn-primary" onserverclick="Linkbtnproccess_Click" onclick="$('#loading').show();"><i class="fa fa-upload fa-lg" aria-hidden="true" ></i> Upload Bill ID</button>
                                                        </div>
                                                 </div>
