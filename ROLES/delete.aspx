<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete.aspx.cs" Inherits="ROLES_delete" %>
          ...
          <div class="card-header">
            ...
            <div class="card-body">
                <div class="row ">
                    ...
                    <asp:LinkButton ID="linkbtnsave" runat="server" CssClass="btn btn-sm btn-primary" OnClick="linkbtnsave_Click" Enabled="false"><i class="fa fa-save" style="color:white" aria-hidden="true"></i> Delete</asp:LinkButton>
