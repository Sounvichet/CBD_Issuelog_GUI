<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smcaactcon.aspx.cs" Inherits="MIGRATION_smcaactcon" %>
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <i class="fa fa-money"></i>
                                                <h3 class="box-title" style="color:blue">Summary Card and Account Reconcile</h3>
                                            </div>
                                            <div class="box-body">
                                                              ...
                                                              <div class="col-md-12">
                                                                  <table style ="width:100%">
                                                                      <tbody>
                                                                          <tr>
                                                                              <td style="width">
                                                                                  <asp:Label ID="l_from_branch" runat="server">From BRANCH:</asp:Label>
                                                                                  <asp:DropDownList ID="d_f_branch" runat ="server" CssClass="textboxstyle" Width="90%"></asp:DropDownList>
                                                                              </td>
                                                                              <td>
                                                                                  <asp:Label ID="l_to_branch" runat="server">To BRANCH:</asp:Label>
                                                                                  <asp:DropDownList ID="d_t_branch" runat ="server" CssClass="textboxstyle" Width="90%"></asp:DropDownList>
                                                                              </td>
                                                                          </tr>
