<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete_biller_dispute.aspx.cs" Inherits="Payment_delete_biller_dispute" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header">
                                <h3 class="box-title">Delete Biller Dispute</h3>
                            </div>
                            <div class="box-body">
                                        <div class="row">
