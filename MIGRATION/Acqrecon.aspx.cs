...
public partial class MIGRATION_Acqrecon : System.Web.UI.Page
{
    ...
    public void _ExportGenerate()
    {
        ...
        DataTable dt4 = _mig.D_get_ACQ_TERM_SMY_MIG();
        workbook.Worksheets.Add(dt1, "acq_term_con");
        workbook.Worksheets.Add(dt2, "acq_term_con_BO1");
        workbook.Worksheets.Add(dt3, "acq_term_con_BO2");
        workbook.Worksheets.Add(dt4, "acq_term_SMY_MIG");
        Response.Clear();
