<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new.aspx.cs" Inherits="ROLES_new" %>
        ...
        <div class="card card-default color-palette-box">
          <div class="card-header">
            ...
            <div class="card-body">
                <div class="row ">
                    <div class="col-md-12">
                    <asp:LinkButton ID="Linkbtnnew" runat="server" CssClass="btn btn-sm btn-primary" OnClick="Linkbtnnew_Click" ><i class="fa fa-plus" style="color:white" aria-hidden="true"></i> New</asp:LinkButton>
