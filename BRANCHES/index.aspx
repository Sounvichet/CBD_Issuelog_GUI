<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="BRANCHES_index" %>
                                    ...
                                    <div class="box-body box-profile">
                                                    <div class="box-header with-border">
                                                        <i class="fa fa-file-text"></i>
                                                         <h3 class="box-title" style="color:blue">Branches information</h3>
                                                     </div>
                                           <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row user-control">
                    <div class="col-lg-12">
                        <div class ="table-responsive">
                            <asp:GridView ID="grid1"  CssClass="table table-bordered table-hover"  runat="server"  AutoGenerateColumns="true" GridLines="None" RowStyle-Wrap="false" OnRowCommand="grid1_RowCommand" onpageindexchanging="grid1_PageIndexChanging" PageSize="10" AllowPaging="true" OnRowDataBound="grid1_RowDataBound">
