<%@ Page Language="C#" AutoEventWireup="true" CodeFile="INCIIS.aspx.cs" Inherits="Report_IncidentReport_INCIIS" %>
...
<body>
    <form id="form1" runat="server">
        <asp:ScriptManager ID="SMinciis" runat="server"></asp:ScriptManager>
                  <asp:UpdatePanel ID="Updateinciis" UpdateMode="Conditional" runat="server">
							                                  <ContentTemplate>
                <div class ="row">
                                            <div class="col-md-12">
                                                                <table width="100%">
                                                                    <tr>
                                                                        <td>
                                                                            Branch_name 
                                                                            <div>
                                                                                <asp:DropDownList ID="D_Branch_name" runat="server" CssClass="textboxstyle" Width="200px" OnSelectedIndexChanged="D_Branch_name_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList> 
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            Terminal_Name
                                                                            <div>
                                                                                <asp:DropDownList ID="D_Terminal_Name" runat="server" CssClass="textboxstyle" Width="200px"></asp:DropDownList>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            Reason Group
                                                                            <div>
                                                                                <asp:DropDownList ID="D_Reason_group" runat="server" CssClass="textboxstyle"></asp:DropDownList>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                        ...
                        <div class="row">
                            <div class="col-lg-12" align="center">
                                 <asp:LinkButton ID="LinkbtnApply" runat="server" CssClass="btn btn-sm btn-primary" OnClick="Button3_Click" ><i class="fa fa-pencil fa-lg" aria-hidden="true"></i> Apply</asp:LinkButton>
                                 <asp:LinkButton ID="Linkbtnexport" runat="server" CssClass="btn btn-sm btn-primary"  OnClick="Button4_Click"><i class="fa fa-save fa-lg" aria-hidden="true" ></i> Export</asp:LinkButton>
                            </div>
                        </div>
                        <p></p>
                        <div class="row">
