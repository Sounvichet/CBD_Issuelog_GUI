<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new.aspx.cs" Inherits="Mission_new" %>
                                                ...
                                                <asp:ScriptManager ID="SMmissnew" runat="server"></asp:ScriptManager>
                                                        ...
                                                        <p></p>
                                                          ...
                                                          <div class = "row">
                                                                ...
                                                                <div class = "col-md-3">
                                                                    <asp:DropDownList ID="d_Branch_Name" runat="server" CssClass = "textboxstyle" Width="200" AutoPostBack="true"
                                                                ...
                                                                <div class = "col-md-3">
                                                                    <asp:DropDownList ID="t_Terminal" runat="server" CssClass = "textboxstyle" Width="200" AutoPostBack="true" OnSelectedIndexChanged="t_Terminal_SelectedIndexChanged"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                           ...
                                                           <div class = "row">
                                                                ...
                                                                <div class = "col-md-3">
                                                                    <asp:DropDownList ID="d_Problem_Type" runat="server" CssClass = "textboxstyle" Width="200">
                                                                    </asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class = "col-md-9">
                                                                    <asp:TextBox ID="T_Problem_desc" runat="server" Width= "1000" TextMode="MultiLine" CssClass = "textboxstyle"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                         ...
                                                         <div class = "row">
                                                                ...
                                                                <div class = "col-md-9">
                                                                    <asp:TextBox ID="t_Equitment" runat="server" Width= "1000" TextMode="MultiLine" CssClass = "textboxstyle"></asp:TextBox>
                                                                </div>
                                                          ...
                                                          <div class = "row">
                                                                ...
                                                                <div class = "col-md-3">
                                                                    <asp:DropDownList ID="d_Name_1" runat="server" CssClass = "textboxstyle" Width="200" AutoPostBack = "true" 
                                                         ...
                                                         <div class = "row">
                                                                ...
                                                                <div class = "col-md-3">
                                                                    <asp:DropDownList ID="d_Name_2" runat="server" CssClass = "textboxstyle" AutoPostBack = "true" 
                                                                        onselectedindexchanged="d_Name_2_SelectedIndexChanged" Width="200">
                                                                    </asp:DropDownList>
                                                                </div>
                                                                <div class = "col-md-3">
                                                        ...
                                                        <div class = "row">
                                                         ...
                                                         <div class = "row">
                                                                ...
                                                                <div class = "col-md-3">
                                                                 ...
                                                                 <div class = "col-md-3">
                                                                     <asp:TextBox ID="t_End_date" runat="server" CssClass = "textboxstyle" OnTextChanged="t_End_date_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                             ...
                                                             <div class="col-md-3">
                                                                <asp:DropDownList ID="D_ActionType" runat="server" CssClass = "textboxstyle" Width="200"></asp:DropDownList>
                                                            </div>
                                                        </div>
