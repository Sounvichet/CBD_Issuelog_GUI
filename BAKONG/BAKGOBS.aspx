<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BAKGOBS.aspx.cs" Inherits="Payment_BAKGOBS" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title" style="color: blue">BAKONG NBC Net settlement</h3>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row user-control">
                                    <div class="col-md-3">
                                        <asp:Label ID="Label6" runat="server" Text="Bakong Settlement Transaction"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row user-control">
                                 ...
                                 <div class="row">
                                    <div class="col-md-12 textboxstyle category_bg">
                                        <asp:Label ID="Label7" runat="server" Font-Bold="true" Text="Bakong OBS Settlement"></asp:Label>
                                    </div>
                                </div>
