<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit.aspx.cs" Inherits="SERVICES_edit" %>
        ...
        <div class="card card-default color-palette-box">
          <div class="card-header">
            ...
            <div class="card-body">
                <div class="row ">
                    <div class="col-md-6">
                         <asp:LinkButton ID="linkbtnupdate" runat="server" CssClass="btn btn-sm btn-primary" OnClick="linkbtnupdate_Click"><i class="fa fa-save" style="color:white" aria-hidden="true"></i> Update</asp:LinkButton>
