<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smdktcon.aspx.cs" Inherits="MIGRATION_smdktcon" %>
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-header with-border">
                                            <i class="fa fa-money"></i>
                                                <h3 class="box-title" style="color:blue">Summary Device Key FE Reconcile</h3>
                                            </div>
                                            <div class="box-body">
