<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete.aspx.cs" Inherits="SERVICES_delete" %>
        ...
        <div class="card card-default color-palette-box">
          <div class="card-header">
            ...
            <div class="card-body">
                <div class="row ">
                    <div class="col-md-6">
                         <asp:LinkButton ID="linkbtnupdate" runat="server" CssClass="btn btn-sm btn-primary" OnClick="linkbtnupdate_Click"><i class="far fa-trash-alt" style="color:white" aria-hidden="true"></i> Delete</asp:LinkButton>
                ...
                <div class="row user-control">
                    <div class="col-md-3">
                        ServiceID<strong style="color:red">*</strong>
                    </div>
                    <div class="col-md-3">
                        <asp:TextBox ID="txtServiceID" runat="server" CssClass="textboxstyle" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="col-md-3">
                        ServiceNameK
                    </div>
                    <div class="col-md-3">
                        <asp:TextBox ID="txtservicename" runat="server" CssClass="textboxstyle"></asp:TextBox>
                    </div>
                </div>
                 ...
                 <div class="row user-control">
                     ...
                     <div class ="col-md-3">
                            <asp:DropDownList ID="D_ServiceStatus" runat ="server" CssClass="textboxstyle">
                            </asp:DropDownList>
                        </div>
                 </div>
